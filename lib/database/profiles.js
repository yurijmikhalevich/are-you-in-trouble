...
exports.makeClient = function (userId, universityDepartmentId, cb) {
  pool.query('UPDATE "' + prefix + 'user" SET role = \'client\', university_department_id = $1, ' +
    'subdepartment_id = NULL WHERE id = $2 RETURNING id', [ universityDepartmentId, userId ],
...
exports.makeHelper = function (userId, chief, subdepartmentId, cb) {
  pool.query('UPDATE "' + prefix + 'user" SET role = $1, subdepartment_id = $2, university_department_id = NULL ' +
    'WHERE id = $3 RETURNING *', [ (chief ? 'subdepartment chief' : 'helper'), subdepartmentId, userId ],
    routines.returnOneEntity(cb));
};
...
exports.makeDepartmentChief = function (userId, cb) {
  pool.query('UPDATE "' + prefix + 'user" SET role = \'department chief\', university_department_id = NULL, ' +
    'subdepartment_id = NULL WHERE id = $1 RETURNING *', [ userId ], routines.returnOneEntity(cb));
};