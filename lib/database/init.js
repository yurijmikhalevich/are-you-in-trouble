      ...
      if (err) {
        ...
        var userData = [
          ...
          { username: 'client1', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client1', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client2', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client3', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client4', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client5', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client6', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client7', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client8', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client9', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client10', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client11', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client12', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client13', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id },
          { username: 'client14', password: '123', email: 'client1@kubsau.ru', role: 'client',
            universityDepartmentId: ids[0][Math.round(Math.random() * (ids[0].length - 1))].id }
        ];
