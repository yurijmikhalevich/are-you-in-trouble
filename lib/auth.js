...
exports.localStrategy = function (username, password, cb) {
  models.User.find({ username: username }, 1, function (err, users) {
    if (err || !users.length) {
...
exports.ldapStrategy = function (user, cb) {
  models.User.find({ email: user.mail }, 1, function (err, users) {
    if (err) {
...
exports.deserializeUser = function (userId, cb) {
  models.User.find({ id: userId }, 1, function (err, users) {
    if (err || !users.length) {
