 ...
 * @param {Function} done
 */
exports.localStrategy = function (login, password, done) {
  models.User.find({ username: login }, 1, function (err, users) {
    if (err || !users.length) {
 ...
 */
exports.register = function (username, password, role, callback) {
